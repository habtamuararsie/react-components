 ...
 <footer className="footer-wrapper">
      <div className="container">
        ...
        <div className="copyright-wrapper row">
          ...
          >
            <div className="flag-wrapper"><img src={flag} alt=''/></div>
...
//               be assessed on fFooterLi l value of new iPhone. Additional terms
//               from Apple or Apple’s trade-in partners may apply. Monthly
//               pricing: Available to qualified customers and requires 0% APR,
//               24-month installment loan with Citizens One or Apple Card Monthly
...
//             <div className="links-wrapper-4 col-sm-12 col-md">
//               <h3>For Business</h3>
//               <Footerli links={["Apple and Business", "Shop for Business"]} />
//               <h3>For Education</h3>
//               <Footerli links={["Apple and Education", "Shop for College"]} />
//               <h3>For Healthcare</h3>
//               <Footerli
//                 links={[
//                   "Manage Your Apple ID",
...
//               />
//               <h3>For Government</h3>
//               <Footerli>"Apple and Education" "Shop for College"</Footerli>
//             </div>
//             <div className="links-wrapper-5 col-sm-12 col-md">
//               <h3>Apple Values</h3>
//               <Footerli>
